...
<?php 
/*
  Created on : 09/03/2020 13:48
  Created by : Augustin ROUSSET-ROUVIERE 
  fichier PHP contenant le routeur qui prends pour base Altorouteur mais qui est augmenté en fonction des besoins de notre site web
**/
=======
<?php
...
class Routeur extends \AltoRouter
{
    ...
    public function getAllPageFrançais():self
    {
        ...
        $this->get('/', 'index','Acceuil base')
            ...
            /*Partie de l'administration des users*/
        ;
