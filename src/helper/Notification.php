...
class Notification
{
    public static function errorNotifPasswordMissMatch($langue)
    {
        ...
        if ($langue === "fr") $result = "Les mots de passe ne sont pas les mêmes";
    ...
    public static function errorNotifWrongPassword($langue)
    {
        ...
        if ($langue === "fr") $result = "Le mail et le mot de passe ne correspondent pas";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    {
        //TODO faire les trads des erreurs le gars n'as pas rentré le bon mots de passe polonais / arabes / anglais
        if ($langue === "fr")      $result = "Nous sommes désolés mais votre fichier dépasse la limite de ".$depassement. " Ko";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    {
        //TODO faire les trads des erreurs le gars n'as pas rentré le bon mots de passe polonais / arabes / anglais
        if ($langue === "fr")      $result = "Une erreur est arrivée durant l'upload du fichier";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    public static function successAddNewQuestion(String $langue)
    {
        ...
        if ($langue === "fr")      $result = "La question a bien été ajoutée à la FAQ !";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    public static function errorAddNewQuestion(String $langue)
    {
        ...
        if ($langue === "fr")      $result = "Un problème est survenu durant l'ajout de la question...";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    {
        //TODO faire les trads de l'erreur  de l'ajout de la nouvelle question polonais / arabes / anglais
        if ($langue === "fr")      $result = "La modification de la question a bien été effectuée ";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    public static function errorUpdateFAQ(string $langue)
    {
        ...
        if ($langue === "fr")      $result = "Une erreur est survenue dans le processus de modification de la question";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    public static function successChangeEmail($langue)
    {
        ...
        if ($langue === "fr")      $result = "Votre adresse email a bien été changée";
        else if ($langue === "ar") $result = "";
        else if ($langue === "pl") $result = "";
        else                       $result = "";
        return $result ;
    ...
    public static function DateDebutSupDatefin(string $langue)
    {
        ...
        if ($langue === "fr")       $result = "La date de recherche du début est supérieure à la date de fin";
        else if ($langue === "ar")  $result = "";
        else if ($langue === "pl")  $result = "";
        else                        $result = "";
        return $result;
