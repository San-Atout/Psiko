        ...
        foreach ($mesTickets as $t)
        {
            ...
            if($t->isArchive()){
                $contenueAAfficher .= "<td class='ticket-tableau-isArchive checked'>Archivé</td><td>
                                    <input class='btn btn-good' type='button' value='Check'></a> </td></tr>";
            }
            else {
                $contenueAAfficher .= "<td class='ticket-tableau-isArchive'>En cours</td><td>
                                    <a href='/fr/tickets/".$t->getIdTicket()."'><input class='btn btn-good' type='button' value='Check' ></a>
                                    <a href='/fr/tickets/".$t->getIdTicket()."/fermer/".$aleatoire."'>
                                        <input class='btn btn-negatif' type='button' value='Close ticket' ></a> 
                                    </td></tr>";
            }
            $i++;
