...
<div class="center">
        ...
        <tbody>
            ...
            foreach ($questions as $q)
            {
                ...
                $contenueLigne .= "<td>".htmlspecialchars($username)."</td>
                                   <td><a href='/fr/admin/faq/".$q->getId()."'> <input class='btn btn-neutral' type='button' value='Pokaż'> </a> 
                                   <a href='/fr/admin/faq/".$q->getId()."/modifier/'><input class='btn btn-good' type='button' value='Edytuj'></a>
                                   <a href='/fr/admin/faq/".$q->getId()."/supprimer/".$aleatoire."'>
                                   <input class='btn btn-negatif' type='button' value='Usuń' ></a> </td>
                ";
    ...
    ?>
    <a href="/fr/admin/faq/ajouter"><input class='btn btn-good' type='button' value='Dodaj pytanie'></a>
</div>
